...
AIVOICE_ALGO_LIB = "-L${S}/prebuilts/lib -laivoice -lafe_kernel -lafe_res_2mic50mm -lkernel -lvad -lkws -lasr -lfst -lnnns -lrnnoise_16k -ltensorflow-lite -lNE10 -lcJSON -ltomlc99"
