...
do_install() {
    ...
    do
		...
		echo "#$label:12345:respawn:${base_bindir}/start_getty -a root ${j} vt102" >> ${D}${sysconfdir}/inittab
    done
...
EOF
        ...
        do
            echo "$n:12345:respawn:${base_sbindir}/getty 38400 tty$n -n -l /bin/sh" >> ${D}${sysconfdir}/inittab
        done
